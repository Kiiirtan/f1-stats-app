...
export default function LiveTelemetry() {
  useDocumentMeta('Live Telemetry – Coming Soon', 'Real-time F1 telemetry, live leaderboards, and race control feeds are under construction. Stay tuned.');
    ...
    <div className="pt-20 pb-20 px-4 md:px-8 max-w-3xl mx-auto w-full flex flex-col items-center justify-center min-h-[70vh] text-center">
      ...
      <div className="relative mb-10">
        ...
        <div className={`relative w-36 h-36 rounded-full flex items-center justify-center border-2 ${glass ? 'bg-white/[0.04] backdrop-blur-xl border-white/10' : 'bg-surface-container border-white/5'}`}>
          <span className="material-symbols-outlined text-white/80" style={{ fontSize: '56px' }}>sensors</span>
        </div>
      </div>
      ...
      <p className="font-label text-sm md:text-base text-white/50 max-w-md leading-relaxed mb-8">
        We're building real-time telemetry dashboards — live leaderboards, race control feeds, and driver performance data streamed directly from the track. This section is currently under development.
      </p>
