          ...
          <div className="flex flex-col gap-3">
            ...
            {activeTab === 'DRIVERS' && drivers.map((driver, idx) => (
              <div 
                ...
                className="group flex flex-col md:flex-row md:items-center px-3 md:px-8 py-4 md:py-7 rounded-2xl bg-black/20 backdrop-blur-md border border-white/10 hover:border-white/30 hover:bg-black/40 transition-all duration-300 cursor-pointer shadow-lg"
              >
                {/* Rank & Driver Profile (Mobile: Row 1, Desktop: Cols 1 & 2) */}
                <div className="flex items-center flex-1 min-w-0 mb-3 md:mb-0">
                  <div className="w-10 md:w-20 flex-shrink-0 font-headline font-black text-2xl md:text-4xl text-white drop-shadow-md">
                  ...
                  <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
                    <img 
                      ...
                      alt={driver.lastName}
                      className="w-10 h-10 md:w-14 md:h-14 rounded-full object-cover object-top border border-white/20 bg-black/50 shadow-inner grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all flex-shrink-0"
                    />
                    <div className="flex flex-col min-w-0">
                      <span className="font-headline font-medium tracking-wide text-[10px] md:text-sm text-white/60 truncate">{driver.firstName}</span>
                      <span className="font-headline font-bold uppercase tracking-widest text-sm md:text-lg text-white truncate drop-shadow-sm leading-tight">{driver.lastName}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 md:gap-0 md:justify-start pl-10 md:pl-0">
                  ...
                  <div className="md:w-32 flex items-baseline gap-1">
                    <span className="font-headline font-bold text-lg md:text-2xl text-white drop-shadow-md">{driver.seasonPoints}</span>
                    <span className="font-headline font-bold text-[10px] text-white/40 tracking-widest">PTS</span>
                  </div>

                  <div className="hidden md:flex md:w-24 justify-end md:justify-center">
              ...
              >
                <div className="flex items-center flex-1 min-w-0 mb-3 md:mb-0">
                  ...
                  <div className="flex items-center gap-2 md:gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex flex-col min-w-0">
                      <span className="font-headline font-bold uppercase tracking-widest text-sm md:text-lg text-white truncate drop-shadow-sm leading-tight">{team.name}</span>
                      <span className="font-headline font-medium tracking-wide text-[10px] md:text-sm text-white/60 truncate">{team.nationality} Team</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap items-center gap-3 md:gap-0 md:justify-start pl-10 md:pl-0">
                  ...
                  <div className="md:w-32 flex items-baseline gap-1">
                    <span className="font-headline font-bold text-lg md:text-2xl text-white drop-shadow-md">{team.points}</span>
                    <span className="font-headline font-bold text-[10px] text-white/40 tracking-widest">PTS</span>
                  </div>
